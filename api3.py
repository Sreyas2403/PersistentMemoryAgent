...
chatbot_agent = Agent(
    ...
    """,
    # Use the tool 'google_search' for queries that requires web search.
    # Use the tool when needed or when you don't have answer.
    # Use the tool for real-time information based user queries.
    # Use the tool for user queries that requires knowledge out of your training data or scope.
    tools = [get_weather]
